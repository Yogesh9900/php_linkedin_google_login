<?php
require "init_linkedin_login.php";
?>
<!DOCTYPE html>
<html>
        ...
        <div class="kpx_login">
            ...
            <div class="row kpx_row-sm-offset-3 kpx_socialButtons">
                ...
                <div class="col-xs-3 col-sm-3">
                    <a href="<?php echo $linkedin->getAuthUrl() ?>" class="btn btn-lg btn-block kpx_btn-linkedin" data-toggle="tooltip" data-placement="top" title="LinkedIn">
